...
<!--<div class="card mb-3">
    ...
    <div class="card-body">
        <form method="post" action="{{ route('administrativo.buscaEstudiante') }}" class="container-fluid" id="form">
            {{ csrf_field() }}
            <div class="form-row justify-content-start">
                ...
                <div class="col-12 col-lg-2">
                    <input class="form-control me-2 mr-2  mt-2 mt-md-0" type="number" id="carnet" aria-label="Search" name="carnet">
                </div>
...
<div class="card mb-3">
    <div class="card-header">
        <h3 style="text-align: center;">Panel de Busqueda | Postgrado</h3>
    </div>
    <div class="card-body">
        <form method="post" action="{{ route('administrativo.buscaEstudiante') }}" class="container-fluid" id="form">
            {{ csrf_field() }}
