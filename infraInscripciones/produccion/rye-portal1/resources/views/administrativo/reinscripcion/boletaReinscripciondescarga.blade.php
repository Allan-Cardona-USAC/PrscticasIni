...
<table>
    ...
    <tr>
        ...
        @case(2)
            @if($monto == 91)
                <td colspan="3" class="detalle">Matrícula Estudiantil anual {{$cicloactivo}}</td>
            @else
                <td colspan="3" class="detalle">Matrícula Estudiantil 2do. Semestre - Reingreso {{$cicloactivo}} Estudiante Regular</td>
            @endif
            @break
        @case(3)
        @case(5)
            <td colspan="3" class="detalle"> Maestrías Y Especialidades {{$cicloactivo}} Inscripción Para Maestrías</td>
            @break
        @case(4)
            <td colspan="3" class="detalle"> Doctorados {{$cicloactivo}} Inscripción Para Doctorados</td>
            @break
        @case(10)
            <td colspan="3" class="detalle"> Postdoctorados {{$cicloactivo}} Inscripción Para Postdoctorados</td>
            @break
        @endswitch
