...
@section('content')
    <div class="container">
        ...
        <div>
            <form action="{{ route('administrativo.BoletaController.descargarBoletaReingresoCiclos') }}" method="GET">
            ...
            <input hidden value="{{$nombreEstudiante}}" id="nombreEstudiante" name="nombreEstudiante"/>
