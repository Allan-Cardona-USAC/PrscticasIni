...
<div class="fondo">
    ...
    <div>
        ...
        <br/>
        <div>
            <p style="font-size:16px; text-align:center; padding-left: 50px; padding-right: 50px;">Es estudiante de la (el) {{$ua}}, carrera: {{$car}}, {{$extension}}, Ciclo académico @foreach($ciclo as $ciclos) @if($ciclos == end($ciclo)) {{$ciclos}}.@else {{$ciclos}},@endif @endforeach</p>
        </div>
        @if($sitAcademica == 2)
