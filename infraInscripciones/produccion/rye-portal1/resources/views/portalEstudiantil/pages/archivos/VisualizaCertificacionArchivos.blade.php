...
<div class="card">
    ...
    <div class="container">
        <div>
            <form action="{{ route('estudiante.archivos.DescargarCertificacionArchivos') }}" method="GET">
            ...
            <table style= "width: 100%; text-align:center; font-size: 16px">
                ...
                <tr>
                    <td style= "text-align: right;"> <b>Para tramite de:</b></td>
            ...
            <br>
            @if($usuarioLinea != 1)
            <p style="font-size:16px; text-align:center;" class="parrafo-1">Generada por el archivo del Departamento de Registro y Estadística, el cual hace constar que el expediente de estudiante se encuentra <strong> COMPLETO </strong> por lo que se extiende la presente.</p>
            @else
            <p style="font-size:16px; text-align:center;" class="parrafo-1">Generada por el archivo del Departamento de Registro y Estadística, el cual hace constar que el estudiante <strong>COMPLETÓ</strong> los requisitos de inscripción en línea según lo resuelto en el acta No. 09-2017. Punto Séptimo, Inciso 7.2 Para el primer ingreso.</p>
            @endif
            </div>
            <br/>
