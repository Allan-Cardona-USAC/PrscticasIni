...
@section('content')
    <div class="container">
        <div>
            ...
            <br/>
            <br/>
            <p style="font-size:16px; text-align:center;"><b>Para continuar con el proceso de inscripción dirigirse al siguiente link, el cual estará habilitado a partir del <i style="font-size: 1.2em;">&nbsp;14 de enero de {{$cicloactivo}}</i>:</b></p>
            <br/>
