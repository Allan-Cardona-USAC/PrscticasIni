...
<div class="container">
    ...
    <div>
        <form action="{{ route('administrativo.descargaCertificacionTitulo') }}" method="POST">
            @csrf
            ...
            <div style="background-color:white;">
                ...
                <div style="text-align:center; font-size:18px;">
                    <p class="titulo-1"><strong>LA JEFATURA DEL DEPARTAMENTO DE REGISTRO Y ESTADÍSTICA DE LA <br>
                        UNIVERSIDAD DE SAN CARLOS DE GUATEMALA.</strong></p>
                </div>
                <br />
                <!--<div style="width: 100%">
                    <p style="font-size:16px; text-align:center;">A solicitud de él interesado</p>
                </div>
                <br>-->
