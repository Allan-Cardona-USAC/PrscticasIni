<div class="sticky-top">
        ...
        <ul class="nav bg-blue justify-content-center">
            ...
            {{-- Administrativo --}}
            <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="drpAdmin" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Administrativo
                    </a>
                    <div class="dropdown-menu" aria-labelledby="drpAdmin">
                        <a class="dropdown-item disabled" href="{{ url('/admin/categorias') }}">Categorias</a>
                        <a class="dropdown-item" href="{{ url('/admin/paginas') }}">Páginas</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item disabled" href="#">Solicitud de Inscripción</a>
                        <a class="dropdown-item" href="#">Inscripción - Reingreso</a>
                        <a class="dropdown-item" href="#">Inscripción - Postgrado</a>
                    </div>
                </li>
        </ul>
    </div>
