<form id="formDatos" action="#">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <label for="inputPIN" class="col-md-1 col-form-label">PIN</label>

                <div class="col-md-2">
                    <input type="text" class="form-control" id="inputPIN" autocomplete="off" value="{{ Auth::guard('aspirante')->user()->pin }}"
                            required>
                </div>
            </div>
            {{-- end NOV --}}
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                <div class="form-group col">
                    ...
                    <small id="ejemplosDirección" class="form-text text-muted">
                        ...
                        Bulever Principal 12-34 Edificio Ejemplo Apartamento 5A Zona 6
                    </small>
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    <label for="inputNIT">N.I.T.</label>
                    <input type="text" id="inputNIT" name="inputNIT"
                           class="form-control"
                           placeholder="NIT"
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label for="inputLugarNacimientoPais">País</label>
    ...
    <div class="form-row">
        <div class="form-group col text-right">
            <input type="button" class="btn btn-primary" value="Continuar" id="inputSubmit" onclick="paso4()">
        </div>
    </div>
</form>
