...
<body>
        ...
        <div>
            ...
            <div style= "text-align:center; font-size:18px;">
                ...
                <br/>
                <strong style="font-size: 14px;">CICLO {{$cicloactivo}}</strong>
            </div>
            <br/>
            <br/>
            <br/>
            <table style= "text-align:left;">
                <tr>
                    <td width="32%"> <b>NÚMERO DE ORIENTACIÓN VOCACIONAL:</b></td>
                    <td>{{$nov}}</td>
            ...
            <p style="text-align:center;">{!!  
                QrCode::size(150)->generate(url("/verificarPreinscripcion?idTransaccion=".$transaccion)); !!} <br/><a style="color:black;" href="{{url('/verificarPreinscripcion?idTransaccion='.$transaccion)}}">Verificar</a>
            </p>
            </div>
            <br/>
