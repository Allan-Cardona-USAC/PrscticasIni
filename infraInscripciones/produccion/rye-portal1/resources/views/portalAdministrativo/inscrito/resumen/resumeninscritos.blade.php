...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('administrativo.resumeninscritos') }}" accept-charset="UTF-8" role="search">
                <div id="imprimible">
                <div class="row justify-content-center">
                    <div class="col-md-4 mb-3">
                        <label for="ciclo" class="col-md-4 col-form-label col-form-label-lg">CICLO: </label>
                        <input type="number" class="form-control form-control-lg" id="ciclo" name="ciclo" placeholder="ciclo" value="{{ isset($ciclo) ? $ciclo : ''}}">
                    </div>
                    <div class="col-md-4 mb-3">
            ...
            <br>
                <div class="table-responsive">
                    ...
                    <table class="table table-striped table-bordered" >
                        <thead>
                        <tr>
                            <th rowspan="2" class="text-center"><h5>RESUMEN</h5></th>
                        ...
                        <tr>
                            <th scope="row" ><h5><a href="{{ route('administrativo.resumeninscritosTipoUA',$resumen->tipo) }}" class="badge badge-info">{{$resumen->descripcion}}</a></h5></th>
