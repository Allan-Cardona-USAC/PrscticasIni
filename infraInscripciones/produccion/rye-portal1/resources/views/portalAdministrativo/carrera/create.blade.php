...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form autocomplete="off" method="POST" action="{{ url('/carrera') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}

                @include ('portalAdministrativo.carrera.form', ['formMode' => 'create'])
