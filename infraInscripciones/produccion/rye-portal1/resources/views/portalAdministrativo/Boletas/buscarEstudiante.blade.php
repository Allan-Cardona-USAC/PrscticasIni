...
<div class="card mb-3">
    <div class="card-header">
        <h3 style="text-align: center;">Panel de Busqueda | Generar Boleta</h3>
    </div>
    <div class="card-body">
        <form method="get" action="{{ route('administrativo.BoletaController.getCarrerasBoleta') }}" class="container-fluid" id="form">
            {{ csrf_field() }}
            ...
            <div class="form-row justify-content-center">
                ...
                <div class="col-12 col-lg-3">
                    <input type="submit" class="btn btn-primary w-100 mt-2 mt-md-0" value="Busqueda">
                </div>
            </div>
        </form>
        <br/>
