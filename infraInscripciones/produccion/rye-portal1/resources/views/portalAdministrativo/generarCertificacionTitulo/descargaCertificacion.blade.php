...
<div class="fondo">
    ...
    <div>
        ...
        <div style="text-align:center; font-size:16px; padding-left: 150px; padding-right: 150px;">
            <strong>LA @if($firma == 'SubJefe')SUBJEFATURA @else JEFATURA @endif DEL DEPARTAMENTO DE REGISTRO Y ESTADÍSTICA DE LA 
        ...
        <!--<div style="text-align: center;">
            ...
            <br/>
            <p style="font-size:16px;">{{$jefatura_nombre}}</p>
            <p style="margin-top: -15px;"><strong style="text-transform:uppercase; font-size:16px;">{{$jefatura_puesto}}</strong>
            <br/>
            <br/>
        </div>-->
        <br>
        ...
        <p style="font-size:0.8em; text-align:left; padding-left: 55px; padding-right: 50px; position: fixed; bottom: 20px">Elaboró {{$user}}<br/></p>
        <br>
