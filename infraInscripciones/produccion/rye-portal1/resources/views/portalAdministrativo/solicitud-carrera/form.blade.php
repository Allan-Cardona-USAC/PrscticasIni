...
<div class="row">
    <div class="col-md-6 form-group {{ $errors->has('fecha_solicitud') ? 'has-error' : ''}}">
        <label for="fecha_solicitud" class="control-label">{{ 'Fecha Solicitud' }}</label>
        <input class="form-control" name="fecha_solicitud" type="date" id="fecha_solicitud" value="{{ isset($carrera->fecha_solicitud) ? $carrera->fecha_solicitud : ''}}" required>
...
<div class="row">
    <div class="offset-md-4 col-md-4 form-group {{ $errors->has('copia_acta') ? 'has-error' : ''}}">
        <label for="copia_acta" class="control-label">{{ 'Copia Acta' }}</label>
        <input class="form-control" name="copia_acta" type="file" id="copia_acta" required>
        {!! $errors->first('copia_acta', '<p class="help-block">:message</p>') !!}
    </div>
</div>
<div class="form-group">
    <div align="center" class="py-2">
        <input class="btn btn-primary btn-sm col-md-3" type="submit" value="Realizar Solicitud">
    </div>
</div>
