...
// CODIGO PARA MODAL DE LA TABLA 4
let modal4 = document.getElementById('tabla_4');
let flex4 = document.getElementById('t4');
let abrir4 = document.getElementById('tabla4');
let abrir4_1 = document.getElementById('tabla4_1');
// let abrir4_2 = document.getElementById('tabla4_2');
// let abrir4_3 = document.getElementById('tabla4_3');
// let abrir4_4 = document.getElementById('tabla4_4');
// let abrir4_5 = document.getElementById('tabla4_5');
let cerrar4 = document.getElementById('close4');

abrir4.addEventListener('click', function () {
    modal4.style.display = 'block';
});
abrir4_1.addEventListener('click', function () {
    modal4.style.display = 'block';
});
// abrir4_2.addEventListener('click', function(){
// modal4.style.display = 'block';
// });
// abrir4_3.addEventListener('click', function(){
// modal4.style.display = 'block';
// });
// abrir4_4.addEventListener('click', function(){
// modal4.style.display = 'block';
// });
// abrir4_5.addEventListener('click', function(){
// modal4.style.display = 'block';
// });
...
let abrir5_1 = document.getElementById('tabla5_1');
// let abrir5_2 = document.getElementById('tabla5_2');
// let abrir5_3 = document.getElementById('tabla5_3');
// let abrir5_4 = document.getElementById('tabla5_4');
// let abrir5_5 = document.getElementById('tabla5_5');
...
// abrir5_2.addEventListener('click', function(){
// modal5.style.display = 'block';
// });
// abrir5_3.addEventListener('click', function(){
// modal5.style.display = 'block';
// });
// abrir5_4.addEventListener('click', function(){
// modal5.style.display = 'block';
// });
// abrir5_5.addEventListener('click', function(){
// modal5.style.display = 'block';
// });
...
let abrir6_1 = document.getElementById('tabla6_1');
// let abrir6_2 = document.getElementById('tabla6_2');
// let abrir6_3 = document.getElementById('tabla6_3');
// let abrir6_4 = document.getElementById('tabla6_4');
// let abrir6_5 = document.getElementById('tabla6_5');
...
// abrir6_2.addEventListener('click', function(){
// modal6.style.display = 'block';
// });
// abrir6_3.addEventListener('click', function(){
// modal6.style.display = 'block';
// });
// abrir6_4.addEventListener('click', function(){
// modal6.style.display = 'block';
// });
// abrir6_5.addEventListener('click', function(){
// modal6.style.display = 'block';
// });
...
let abrir7 = document.getElementById('tabla7');
let abrir7_1 = document.getElementById('tabla7_1');
// let abrir7_2 = document.getElementById('tabla7_2');
// let abrir7_3 = document.getElementById('tabla7_3');
// let abrir7_4 = document.getElementById('tabla7_4');
// let abrir7_5 = document.getElementById('tabla7_5');
...
// abrir7_2.addEventListener('click', function(){
// modal7.style.display = 'block';
// });
// abrir7_3.addEventListener('click', function(){
// modal7.style.display = 'block';
// });
// abrir7_4.addEventListener('click', function(){
// modal7.style.display = 'block';
// });
// abrir7_5.addEventListener('click', function(){
// modal7.style.display = 'block';
// });
...
let abrir8 = document.getElementById('tabla8');
let abrir8_1 = document.getElementById('tabla8_1');
// let abrir8_2 = document.getElementById('tabla8_2');
// let abrir8_3 = document.getElementById('tabla8_3');
// let abrir8_4 = document.getElementById('tabla8_4');
// let abrir8_5 = document.getElementById('tabla8_5');
...
// abrir8_2.addEventListener('click', function(){
// modal8.style.display = 'block';
// });
// abrir8_3.addEventListener('click', function(){
// modal8.style.display = 'block';
// });
// abrir8_4.addEventListener('click', function(){
// modal8.style.display = 'block';
// });
// abrir8_5.addEventListener('click', function(){
// modal8.style.display = 'block';
// });
...
// let abrir9 = document.getElementById('tabla9');
// let abrir9_1 = document.getElementById('tabla9_1');
// let abrir9_2 = document.getElementById('tabla9_2');
// let abrir9_3 = document.getElementById('tabla9_3');
// let abrir9_4 = document.getElementById('tabla9_4');
// let abrir9_5 = document.getElementById('tabla9_5');
...
// modal9.style.display = 'block';
// });
// abrir9_2.addEventListener('click', function(){
// modal9.style.display = 'block';
// });
// abrir9_3.addEventListener('click', function(){
// modal9.style.display = 'block';
// });
// abrir9_4.addEventListener('click', function(){
// modal9.style.display = 'block';
// });
// abrir9_5.addEventListener('click', function(){
// modal9.style.display = 'block';
// });
...
// // CODIGO PARA MODAL DE LA TABLA 10
// let modal10= document.getElementById('tabla_10');
// let flex10 = document.getElementById('t10');
// let abrir10 = document.getElementById('tabla10');
// let abrir10_1 = document.getElementById('tabla10_1');
// let abrir10_2 = document.getElementById('tabla10_2');
// let abrir10_3 = document.getElementById('tabla10_3');
// let abrir10_4 = document.getElementById('tabla10_4');
// let abrir10_5 = document.getElementById('tabla10_5');
// let cerrar10 = document.getElementById('close10');

// abrir10.addEventListener('click', function(){
// modal10.style.display = 'block';
// });
// abrir10_1.addEventListener('click', function(){
// modal10.style.display = 'block';
// });
// abrir10_2.addEventListener('click', function(){
// modal10.style.display = 'block';
// });
// abrir10_3.addEventListener('click', function(){
// modal10.style.display = 'block';
// });
// abrir10_4.addEventListener('click', function(){
// modal10.style.display = 'block';
// });
// abrir10_5.addEventListener('click', function(){
// modal10.style.display = 'block';
// });
